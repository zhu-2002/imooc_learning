package multi_threaded_downloader;
...
public class Downloader {
    ...
    public static void main(String[] args) {
        ...
        downloader.start("./src/multi_threaded_downloader");
        // 确保保存路径已经存在
        //downloader.downloader("https://cdn.jsdelivr.net/gh/zhu-2002/img/20230515222931.png","./src/multi_threaded_downloader/pic");
    }
}
